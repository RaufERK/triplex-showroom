...
```
--triplex-next-ColorBrand-0-1-1-1    #1F3336  (самый тёмный)
...
--triplex-next-ColorBrand-50-1-1-1   #21A19A  ⭐ основной
...
--triplex-next-ColorBrand-100-1-1-1  #E3FFFA  (самый светлый)
```

### Neutral (Серые для фонов и границ)
```
--triplex-next-ColorNeutral-100-1-1-1  #ffffff  белый
--triplex-next-ColorNeutral-90-1-1-1   #f2f4f7  светло-серый фон
--triplex-next-ColorNeutral-80-1-1-1   #eef0f4
--triplex-next-ColorNeutral-70-1-1-1   #eaedf1
--triplex-next-ColorNeutral-60-1-1-1   #e7e9ee  границы
--triplex-next-ColorNeutral-50-1-1-1   #e3e6ea  ⭐ основной для границ
--triplex-next-ColorNeutral-40-1-1-1   #d1d5dc
--triplex-next-ColorNeutral-30-1-1-1   #b8bdc5
--triplex-next-ColorNeutral-20-1-1-1   #9fa6ae
--triplex-next-ColorNeutral-10-1-1-1   #868e98
--triplex-next-ColorNeutral-0-1-1-1    #6d7681  тёмно-серый
```

### DarkNeutral (Тёмные для текста)
```
--triplex-next-ColorDarkNeutral-0-1-1-1    #000000  чёрный
...
--triplex-next-ColorDarkNeutral-50-1-1-1   #2D2D30  ⭐ основной текст
...
```
--triplex-next-ColorError-50-1-1-1   #E60037  ⭐ основной (ошибки)
--triplex-next-ColorError-90-1-1-1   #FCE0E6  светлый фон (для уведомлений)
```

### Info (Синие для информации)
```
--triplex-next-ColorInfo-50-1-1-1    #1371E4  ⭐ основной (инфо)
--triplex-next-ColorInfo-90-1-1-1    светлый фон
```

### Success (Зелёные для успеха)
```
--triplex-next-ColorSuccess-50-1-1-1  ⭐ основной (успех)
```

### Warning (Жёлтые для предупреждений)
```
--triplex-next-ColorWarning-50-1-1-1  ⭐ основной (предупреждение)
```
...
.cardHeader {
  background: var(--triplex-next-ColorBrand-90-1-1-1);
  color: var(--triplex-next-ColorBrand-20-1-1-1);
}
```
...
.button:hover {
  background: var(--triplex-next-ColorBrand-40-1-1-1);
}
```
